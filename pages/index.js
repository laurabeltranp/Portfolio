          ...
          <Row>
            <Col md={4} className="mb-4 text-center">
              ...
              <div className="d-flex justify-content-center">
                ...
                <Button variant="outline-light" href="https://adoptafur.com" target="_blank" className="d-flex align-items-center mx-2">
            ...
            <Col md={4} className="mb-4 text-center">
              ...
              <div className="d-flex justify-content-center">
                <Button variant="outline-light" href="https://github.com/your-username/optimus-educacion" target="_blank" className="d-flex align-items-center mx-2">
                  <FaGithub className="mr-2" /> Ir al código
                </Button>
                <Button variant="outline-light" href="https://optimuseducacion.com" target="_blank" className="d-flex align-items-center mx-2">
                  <FaExternalLinkAlt className="mr-2" /> Ir a la web
                </Button>
              </div>
            </Col>
